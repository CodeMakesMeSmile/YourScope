...
> More information in standup required. Please be more detailed.
...
> Some dont have ticket numbers "fix: added missing getUserById function"
...
> More detail required for system architecture diagram. Everything else is good.
